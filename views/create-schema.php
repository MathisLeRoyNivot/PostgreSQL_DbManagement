            ...
            <form action="../includes/queries/create-schema.query.php" method="post">
                ...
                <div class="row">
                    <div class="input-group mb-3">
                        <textarea class="form-control" name="create-schema-input" placeholder="Query insert statement" id="exampleTextarea" rows="3" style="min-height:45px;"></textarea>
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" name="create-schema-submit" type="submit">Execute request</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        CREATE SCHEMA schema_name [ AUTHORIZATION user_name ] [ schema_element [ ... ] ]<br>
                        CREATE SCHEMA AUTHORIZATION user_name [ schema_element [ ... ] ]<br>
                        CREATE SCHEMA IF NOT EXISTS schema_name [ AUTHORIZATION user_name ]<br>
